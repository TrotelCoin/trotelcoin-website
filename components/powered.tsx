        ...
        <div className="mt-16 flex justify-center">
          <p className="relative rounded-full bg-gray-50 px-4 py-1.5 text-sm leading-6 text-gray-600 ring-1 ring-inset ring-gray-900/5">
            <span className="hidden md:inline">
              Avec Flooz, vous avez la possibilité d'acheter des TrotelCoin en
              utilisant Apple Pay et Google Pay.
            </span>
            <a
            ...
            >
              <span className="absolute inset-0" aria-hidden="true" /> C'est
              quoi Flooz ? <span aria-hidden="true">&rarr;</span>
            </a>
          </p>
        </div>
      </div>
