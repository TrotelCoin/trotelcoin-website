            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mx-auto">
              {featuresData.map((feature, index) => (
                ...
                >
                  ...
                  >
                    <div
                      className={`flex bg-white dark:bg-gray-800 dark:hover:bg-gray-700 border border-gray-900/10 hover:border-gray-900/50 dark:border-transparent backdrop-blur-2xl p-6 rounded-xl`}
                    >
