  ...
  return (
    <>
      <div className="pointer-events-none fixed inset-x-0 bottom-0 sm:flex sm:justify-center sm:px-6 sm:pb-5 lg:px-8">
        <div className="pointer-events-auto flex items-center justify-between gap-x-6 bg-black dark:bg-stone-100 px-6 py-2.5 hover:bg-stone-800 dark:hover:bg-white sm:rounded-xl sm:py-3 sm:pl-4 sm:pr-3.5">
